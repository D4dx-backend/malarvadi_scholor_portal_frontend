    ...
    <header className="bg-white shadow-sm border-b border-gray-200">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-14 sm:h-16">
          ...
          {/* Admin Login Button - Hidden on mobile screens */}
          ...
          {/* Mobile Admin Access - Small icon button for tablets */}
          <div className="md:hidden flex items-center">
            <button 
              onClick={() => navigate('/admin/login')}
              className="hidden sm:inline-flex items-center p-2 border border-gray-300 rounded-md text-gray-600 hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-500 transition-colors duration-200"
              title="Admin Login"
            >
              <svg 
                className="w-5 h-5" 
